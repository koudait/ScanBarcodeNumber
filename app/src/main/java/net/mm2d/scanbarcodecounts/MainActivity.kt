...
import net.mm2d.scanbarcodecounts.code.CodeScanner
import net.mm2d.scanbarcodecounts.databinding.ActivityMainBinding
import net.mm2d.scanbarcodecounts.extension.formatString
import net.mm2d.scanbarcodecounts.extension.typeString
import net.mm2d.scanbarcodecounts.permission.CameraPermission
import net.mm2d.scanbarcodecounts.permission.PermissionDialog
import net.mm2d.scanbarcodecounts.result.ScanResult
import net.mm2d.scanbarcodecounts.result.ScanResultAdapter
import net.mm2d.scanbarcodecounts.result.ScanResultDialog
import net.mm2d.scanbarcodecounts.setting.Settings
import net.mm2d.scanbarcodecounts.util.ReviewRequester
import net.mm2d.scanbarcodecounts.util.Updater
