...
import net.mm2d.scanbarcodecounts.R
import net.mm2d.scanbarcodecounts.databinding.DialogResultBinding
import net.mm2d.scanbarcodecounts.util.ClipboardUtils
